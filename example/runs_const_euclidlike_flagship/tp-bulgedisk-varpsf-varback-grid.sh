...
WORKDIR=/vol/euclidraid5/data/aanavarroa/catalogs/MomentsML2/fullimages_constimg_euclid-flagship0.05/tp-bulgedisk-varpsf-varback-grid2
SIMDIR=$WORKDIR/sim
