...
python make_uniformtp.py --loglevel=INFO --workdir=$WORKDIR  --constants=$CONSTANTS --tru_type=2 --dist_type=uniflagship --ncpu=127 --ncat=3000 --skipdone --npairs=1024 --patience=100 --subsample_nbins=2 --runadamom #--drawcat --usevarpsf --usevarsky 
