...
python make_uniformtp.py --loglevel=INFO --workdir=$WORKDIR  --constants=$CONSTANTS --tru_type=2 --dist_type=uniflagship --ncpu=123 --ncat=5000 --skipdone --max_shear=0 --runadamom --npairs=50 --patience=100 --subsample_nbins=2 #--drawcat --usevarpsf --usevarsky 
